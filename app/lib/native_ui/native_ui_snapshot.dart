...
const nativeUiSnapshotSchemaVersion = 1;
...
class NativeUiSnapshot {
  ...
  factory NativeUiSnapshot.build({
    ...
    final favoriteFingerprints = favorites.map((favorite) => favorite.fingerprint).toSet();
    final devices =
        nearbyDevices.allDevices.values
          ...
          ..sort((a, b) {
            ...
            return aliasComparison != 0 ? aliasComparison : a.id.compareTo(b.id);
          });
    ...
    return NativeUiSnapshot(
      ...
      port: port,
      https: https,
      scanning: nearbyDevices.runningFavoriteScan || nearbyDevices.runningIps.isNotEmpty,
